...
BEGIN Facility
    ...
    Name		 Cape_Canaveral_AFS_SLC_17B_STDN_B17P

    BEGIN CentroidPosition

        CentralBody		 Earth
        DisplayCoords		 Geodetic
        EcfLatitude		  2.8445790420000002e+01
        EcfLongitude		 -8.0565649440000001e+01
        EcfAltitude		 -7.2500000000000000e+00
        HeightAboveGround		  0.0000000000000000e+00
        ComputeTrnMaskAsNeeded		 Off
        AzElMask		 AzElMaskFile: Cape_Canaveral_AFS_SLC_17B_STDN_B17P.aem
    ...
    BEGIN Extensions
        ...
        BEGIN Desc
            BEGIN ShortText
Cape Canaveral AFS SLC 17B STDN B17P
Name:           Cape Canaveral AFS SLC 17B STDN B17P
Country:        UnitedStates
Location:       Cape Canaveral, Florida
Status:         Active
Type:           LaunchPad
Alternate name: Space Launch Complex 17B
Notes:          NASA# 1472 || Equipment: Launch station   || Remarks: 10-91 stand 17B DELTA
